#
#  Be sure to run `pod spec lint LMFonts.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.license      = "MIT"
  # s.license      = { :type => "MIT", :file => "https://github.com/leomodro/LMFonts/blob/master/LICENSE" }
  ...
  s.author             = { "Leonardo Modro" => "leonardomodro@hotmail.com" }
  # Or just: s.author    = "Leonardo Modro"
  # s.authors            = { "Leonardo Modro" => "leonardomodro@hotmail.com" }
  s.social_media_url   = "http://twitter.com/leomodro"
  ...
  s.source       = { :git => "https://github.com/leomodro/LMFonts.git", :tag => "#{s.version}" }
